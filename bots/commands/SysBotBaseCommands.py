...
class SysBotBaseCommands:
    ...
    def click(self, button: str, sleep: float = 0) -> None:
        self.sendCommand(f'click {button}')
        time.sleep(sleep)

    def press(self, button: str, sleep: float = 0) -> None:
        self.sendCommand(f'press {button}')
        time.sleep(sleep)

    def release(self, button: str, sleep: float = 0) -> None:
    ...
    def freeze(self, pointer: List, data: str) -> None:
        ofs = self.resolvePointer(pointer)
        self.sendCommand(f'freeze 0x{ofs.decode().rstrip()} {data}')

    def clickA(self, sleep: float = 0) -> None:
        self.sendCommand("click A")
        time.sleep(sleep)

    def clickB(self, sleep: float = 0) -> None:
        self.sendCommand("click B")
        time.sleep(sleep)

    def clickY(self, sleep: float = 0) -> None:
        self.sendCommand("click Y")
        time.sleep(sleep)

    def clickX(self, sleep: float = 0) -> None:
        self.sendCommand("click X")
        time.sleep(sleep)

    def clickUp(self, sleep: float = 0) -> None:
        self.sendCommand("click DUP")
        time.sleep(sleep)

    def clickDown(self, sleep: float = 0) -> None:
        self.sendCommand("click DDOWN")
        time.sleep(sleep)

    def clickLeft(self, sleep: float = 0) -> None:
        self.sendCommand("click DLEFT")
        time.sleep(sleep)

    def clickRight(self, sleep: float = 0) -> None:
        self.sendCommand("click DRIGHT")
        time.sleep(sleep)

    def clickL(self, sleep: float = 0) -> None:
        self.sendCommand("click L")
        time.sleep(sleep)

    def clickR(self, sleep: float = 0) -> None:
        self.sendCommand("click R")
        time.sleep(sleep)

    def clickZL(self, sleep: float = 0) -> None:
        self.sendCommand("click ZL")
        time.sleep(sleep)

    def clickZR(self, sleep: float = 0) -> None:
        self.sendCommand("click ZR")
        time.sleep(sleep)

    def clickPlus(self, sleep: float = 0) -> None:
        self.sendCommand("click PLUS")
        time.sleep(sleep)

    def clickMinus(self, sleep: float = 0) -> None:
        self.sendCommand("click MINUS")
        time.sleep(sleep)

    def clickHome(self, sleep: float = 0) -> None:
        self.sendCommand("click HOME")
        time.sleep(sleep)

    def clickCapture(self, sleep: float = 0) -> None:
        self.sendCommand("click CAPTURE")
        time.sleep(sleep)

    def moveForward(self, sleep: float = 0) -> None:
