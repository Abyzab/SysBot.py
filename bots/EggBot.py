...
class EggBotConnection:
    ...
    def bikeUntilEgg(self) -> None:
        ...
        self.commands.poke(self.pointers['player_x'],
                           "0x00000CC400000040AC3F1E44000000000000008000000080000000800000803F0000803F0000803F0000803F")  # Please don't look at them I'm ashamed
    ...
    def collectEgg(self) -> None:
        self.commands.poke(self.pointers['player_x'],
                           "0xFCFF0AC400000040D6FE21440000000000000080F404353F00000080F404353F0000803F0000803F0000803F")  # Please god send help it works
        time.sleep(0.4)
        self.commands.clickA(0.5)
